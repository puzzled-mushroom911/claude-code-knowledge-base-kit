#!/usr/bin/env python3
"""
Pre-configured consulting scenarios for YouTube creators.
...
optional profile.yaml; sensible defaults are used when the file is missing.
...
# Default database paths -- override via profile.yaml or CLI
DEFAULT_STRATEGY_DB = "./kb_youtube_strategy"
DEFAULT_EXAMPLES_DB = "./kb_youtube_examples"

# ---------------------------------------------------------------------------
# Preset scenarios (industry-agnostic)
# ---------------------------------------------------------------------------
SCENARIOS: Dict[str, Dict[str, Any]] = {
    "channel-setup": {
        "query": "How to set up and launch a YouTube channel for business",
        "description": "Complete channel setup guide",
        "databases": "both",
        "k": 5,
    },
    "content-ideas": {
        "query": "Best video content ideas for growing a business YouTube channel",
        "description": "Video content strategy and ideas",
        "databases": "both",
        "k": 6,
    },
    "lead-generation": {
        "query": "How to generate leads from YouTube videos",
        "description": "Lead generation strategies from YouTube",
        "databases": "both",
        "k": 5,
    },
    "thumbnails-titles": {
        "query": "YouTube thumbnail and title best practices for higher click-through rate",
        "description": "Thumbnail and title optimization",
        "databases": "strategy",
        "k": 4,
    },
    "seo-strategy": {
        "query": "YouTube SEO and discoverability strategies for business channels",
        "description": "SEO and video ranking strategies",
        "databases": "both",
        "k": 5,
    },
    "engagement": {
        "query": "How to increase engagement and subscribers on a business YouTube channel",
        "description": "Subscriber and engagement growth",
        "databases": "both",
        "k": 5,
    },
    "authority-content": {
        "query": "Best practices for creating authority and expertise content on YouTube",
        "description": "Authority and thought leadership content",
        "databases": "examples",
        "k": 5,
    },
    "conversion": {
        "query": "Converting YouTube viewers into customers and clients",
        "description": "Viewer to customer conversion strategy",
        "databases": "both",
        "k": 5,
    },
}
...
def load_profile_config() -> Dict[str, str]:
    """
    Attempt to read database paths from profile.yaml.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Pre-configured YouTube consulting queries.",
