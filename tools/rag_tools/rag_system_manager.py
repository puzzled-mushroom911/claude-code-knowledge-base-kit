...
Examples:
    python3 rag_system_manager.py register market_data "Local market stats" ./market_kb documents
...
# Constants
# ---------------------------------------------------------------------------
DEFAULT_MANIFEST_DIR = Path.home() / ".knowledge_base_ai"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            '  python3 rag_system_manager.py register market_data "Market stats" ./market_kb documents\n'
            "  python3 rag_system_manager.py list\n"
            "  python3 rag_system_manager.py path market_data\n"
            "  python3 rag_system_manager.py summary\n"
        ),
