#!/usr/bin/env bash
# ============================================================
# Knowledge Base Kit - Setup Script
# ============================================================
...
CONFIG_DIR="$HOME/.knowledge_base_ai"

echo "============================================================"
echo "  Knowledge Base Kit - Setup"
echo "============================================================"
echo ""
...
echo ""
echo "Next steps:"
echo "  1. Edit config/profile.yaml with your info"
echo "  2. Edit config/channels.yaml with your YouTube channels"
echo "  3. (Optional) Edit config/.env with your API keys"
echo ""
echo "Quick start:"
...
echo "  {\"mcpServers\": {\"knowledge-base\": {"
echo "    \"command\": \"node\","
